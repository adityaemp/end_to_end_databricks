...
# ``end_to_end_databricks/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-end_to_end_databricks-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.end_to_end_databricks.end_to_end_databricks-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.end_to_end_databricks.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.end_to_end_databricks.trip_dropoff_features",
