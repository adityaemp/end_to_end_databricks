...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``end_to_end_databricks/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in end_to_end_databricks/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in end_to_end_databricks/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-end_to_end_databricks-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.end_to_end_databricks.end_to_end_databricks-model", "Full (Three-Level) Model Name")
