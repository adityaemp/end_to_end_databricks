...
git add README.md docs .gitignore end_to_end_databricks/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-314d456b-c68f.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-314d456b-c68f.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[end_to_end_databricks/databricks.yml](../end_to_end_databricks/databricks.yml) file.
...
Follow the instructions in [end_to_end_databricks/resources/README.md](../end_to_end_databricks/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../end_to_end_databricks/resources/README.md)  to propose, test, and deploy
