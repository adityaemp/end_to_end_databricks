...
Opening a pull request will trigger a[workflow](../.github/workflows/end_to_end_databricks-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-314d456b-c68f.cloud.databricks.com/explore/data/models/staging/end_to_end_databricks/end_to_end_databricks-model)
* [Prod model in UC](https://dbc-314d456b-c68f.cloud.databricks.com/explore/data/models/prod/end_to_end_databricks/end_to_end_databricks-model)
. 
